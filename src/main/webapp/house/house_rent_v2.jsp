                   ...
                   <ul class="InputMainLine KY_W" style=" margin-bottom:8px;">
                        ...
                        <li>
                            ...
                            <div class="ulErMenu"> 
                                ...
                                <p onclick="addQueryStr('scope')" id="seeComp"><label><input type="radio" text="公司" name="scope"   <c:if test="${seeComp }">   checked="checked" </c:if>  value="comp">公司</label> </p> 
                                <c:if test="${seeGX }"> 
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0" class="KY_TableMain TableB table-hover" id="KY_TableMain">
                                                        <tr data-hid="$[id]" style="display:none;" class="id_House_list" >
                                                          ...
                                                          <td  width="75"  auth="fy_sh|fy_edit|fy_del">
                                                            ...
                                                            <c:if test="${authNames.contains('fy_ruku') }">
                                                            	<a id="btn_ruku_$[id]" auth="fy_ruku" href="#" show="$[ruku]==0" onclick="ruku($[id])">入库</a>
                                                            </c:if>
                                                          </td>
                                                          </c:if>
