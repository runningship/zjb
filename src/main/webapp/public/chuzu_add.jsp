...
<form action="" name="form1">
    ...
    <ul class="form-ul forms_reg">
      ...
      <li class=""><label class="form-section form-section-tow one form-active"><strong class="input-label">面积</strong><input type="text" name="mji" class="input placeholder u" desc="面积" placeholder="面积"></label>
      <label class="form-section form-section-tow form-active"><strong class="input-label">月租金</strong><input type="text" name="zjia" class="input placeholder u" desc="月租金" placeholder="月租金"></label></li>
