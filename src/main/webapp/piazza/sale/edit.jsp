...
<input name="id" id="id" type="hidden" value="${sale.id}">
<table class="table table-bordered table-hover m10" style="width:100%; height:100%; font-family:'宋体'; font-size:13px; padding-top:15px;">
    <tr>
      ...
      <td valign="middle"><input type="text" name="title" style="border:1px solid #d4d4d4; padding:4px 3px; border-radius:3px;" value="${sale.title}"/></td>
    </tr>
    <!-- <tr>
...
<div id="sale_conts" style="display:none">${sale.conts}</div>
</body>
</html>