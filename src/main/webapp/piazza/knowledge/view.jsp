        ...
        <div class="textMoeInfoMain">
            <div class="layerInfoBox">
                ...
                <div class="layerInfoBoxContent">
                     ...
                     <span class="marginRight55 marginLeft20"><span>阅读：<i name="reads" id="reads"></i></span> &nbsp;&nbsp;&nbsp; <span>留言：<i name="replys" id="replys"></i></span><span class="Fright"><a href="list.jsp" target="_self" class="back">返回文章列表</a></span></span><!-- onclick="window.location='/oa/article/list.html'"-->
