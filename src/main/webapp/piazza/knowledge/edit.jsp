...
$(function(){
    ...
    ue.addListener( 'ready', function( editor ) {
        ue.setContent($('#knowledge_conts').html());
    });
    // getContent();
});
...
<table class="table table-bordered table-hover m10" style="width:100%; height:100%; font-family:'宋体'; font-size:13px; padding-top:15px;">
    <tr>
      ...
      <td valign="middle"><input type="text" name="title" style="border:1px solid #d4d4d4; padding:4px 3px; border-radius:3px;" value="${knowledge.title}"/></td>
    </tr>
    <!-- <tr>
