...
$(document).ready(function() {
    $(document).find('.form-active .input').focusin(function(){
        $(this).parents('.form-active').addClass('active').addClass('focus');
    }).focusout(function(){
        if($(this).is('select')){
            if($(this).is(":selected")){
                $(this).parents('.form-active').removeClass('active');
            }
        }else{
            if(!$(this).val()){
                $(this).parents('.form-active').removeClass('active');
        ...
        $(this).parents('.form-active').removeClass('focus').removeClass('curr');
    }).hover(function() {
        $(this).parents('.form-active').addClass('hover');
    }, function() {
        $(this).parents('.form-active').removeClass('hover');
    }).each(function(index, el) {
        if($(this).is('select')){
            $(this).parents('.form-active').addClass('curr');
        }
    });
});
