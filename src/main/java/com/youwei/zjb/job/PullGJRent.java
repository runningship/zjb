...
public class PullGJRent extends AbstractJob implements HouseRentJob{
	...
	public static void main(String[] args){
		...
		HouseRent hr = PullDataHelper.pullDetail(instance.action , "http://hf.ganji.com/fang1/1755138724x.htm" ,null ,RentType.整租 ,null);
//		dao.saveOrUpdate(hr);
//		instance.work();
	}
...
//			IMServer.sendMsgToUser(PullDataHelper.errorReportUserId, "本次共处"+action.getSiteName()+"理房源数:"+count);
			...
			LogUtil.log(Level.WARN, "ganji扫网任务失败", ex);
		}
	}
